...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 799.66663646697998, 564.0, 67.0, 62.0 ],
					"text" : "seq.note.step \"4 3 6\" seq.note.step \"6 4 7\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 815.66663646697998, 352.041666626930237, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 754.208305478096008, 469.0, 53.0, 22.0 ],
					"text" : "list.iter 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 754.208305478096008, 499.208332180976868, 96.0, 22.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-25",
					"items" : [ "seq.note.step", "4 3 6", ",", "seq.note.step", "6 4 7" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 754.208305478096008, 529.416664361953735, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 691.666640281677246, 153.124994158744812, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.666640281677246, 243.749990701675415, 197.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.666640281677246, 39.583331823348999, 29.5, 22.0 ],
					"text" : "4 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 730.208305478096008, 40.624998450279236, 83.0, 20.0 ],
					"text" : "Block, Pattern"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.666640281677246, 126.041661858558655, 35.0, 22.0 ],
					"text" : "4 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 732.291638731956482, 154.166660785675049, 150.0, 20.0 ],
					"text" : "Block, Voicenum, Pattern"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.083306550979614, 179.166659832000732, 245.0, 49.0 ],
					"text" : ";\rto_blockmanager clear_voice_pattern $1 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.666640281677246, 67.708330750465393, 242.0, 35.0 ],
					"text" : ";\rto_blockmanager clear_block_pattern $1 $2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 173.0, 131.0, 86.0, 22.0 ],
									"text" : "prepend name"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 267.0, 131.0, 86.0, 22.0 ],
									"text" : "prepend name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 2,
									"outlettype" : [ "blocks", "voicemap" ],
									"patching_rect" : [ 173.0, 94.0, 113.0, 22.0 ],
									"text" : "t blocks voicemap"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 272.0, 719.0, 45.0, 22.0 ],
									"text" : "zl rot 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.5, 541.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 272.0, 746.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 272.0, 695.0, 93.5, 22.0 ],
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 203.5, 441.0, 29.5, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 346.5, 513.0, 37.0, 22.0 ],
									"text" : "zl nth"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 203.5, 478.0, 180.0, 22.0 ],
									"text" : "t getkeys i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 173.0, 59.0, 49.0, 22.0 ],
									"text" : "r MTInit"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 492.0, 43.0, 22.0 ],
									"text" : "zl lace"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 272.0, 776.0, 51.0, 22.0 ],
									"text" : "zl group"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 272.0, 666.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 272.0, 634.0, 51.0, 22.0 ],
									"text" : "zl group"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 236.0, 571.0, 55.0, 22.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "", "int" ],
									"patching_rect" : [ 272.0, 600.0, 78.0, 22.0 ],
									"text" : "array.foreach"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 513.0, 73.0, 22.0 ],
									"text" : "prepend get"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 173.5, 277.0, 51.0, 22.0 ],
									"text" : "zl group"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 173.5, 311.0, 149.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 225.0, 541.0, 61.0, 22.0 ],
...
,
					"patching_rect" : [ 754.208305478096008, 393.708331704139709, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 754.208305478096008, 351.0, 35.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.499978542327881, 33.333332061767578, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.833333333333371, 33.333332061767578, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 631.249975919723511, 387.499985218048096, 50.0, 22.0 ]
				}
